    ...
    return (
      <section id="projects" className="p-8">
        ...
        <div className="space-y-4">
          ...
          <div className="pl-4 space-y-1">
            <h3 className="text-2xl font-bold">PF2e AIOQR</h3>
            <p className="max-w-xl text-xl text-slate-600">Pathfinder 2nd Edition All In One Quick Reference</p>
            <p className="max-w-xl text-lg text-slate-900">A webapp Game Master screen for the second edition of the table top role playing game Pathfinder. As a traditional pen and paper style TTRPG, Pathfinder 2e has an enormous catalogue of rules that must either be memorized or readily available to play the game. This quick reference is an attempt by me to streamline the rules lookup</p>
          </div>
