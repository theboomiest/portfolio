      ...
      <section id="projects" className="p-8 w-3/5">
        ...
        <div className="space-y-6">
          <div className="p-4 space-y-2 bg-transparent transition-all duration-300 ease-in-out hover:bg-lime-700 hover:bg-opacity-20 rounded-lg hover:shadow-lg">
            <h3 className="text-2xl font-bold hover:text-blue-800 w-fit"><a href="https://github.com/theboomiest/pf2e_ref/tree/master/reference-page">PF2e Command Screen</a></h3>
            <p className="pl-4 text-xl text-slate-600">Pathfinder 2nd Edition Digital Game Master Screen</p>
          ...
          <div className="p-4 space-y-2 bg-transparent transition-all duration-300 ease-in-out hover:bg-cyan-800 hover:bg-opacity-20 rounded-lg hover:shadow-lg">
            <div className="flex items-start space-x-2">
              ...
              <h3 className="text-2xl font-bold hover:text-blue-800 w-fit"><a href="https://umbrage.world" target='_blank'>umbrage.world</a></h3>
            </div>
            <p className="pl-4 text-xl text-slate-600">Campaign website for Pathfinder 2e with custom wiki-style setting documentation</p>
            <p className="text-lg text-slate-900">A Wordpress website for a custom PF2e campaign. Featuring a robust wiki that contains all the custom setting information compiled using Quartz interpreting a directory of Markdown files. The setting page is hosted on a static GitPage.</p>
          </div>
