...
export default function Navbar({ toggleSection }) {
  return (
    <nav className="border-gray-500 border-2 bg-transparent transition-all duration-300 ease-in-out p-12 rounded-lg hover:shadow-lg hover:bg-white hover:bg-opacity-70 flex-initial space-y-6 md:space-y-10 fixed">
